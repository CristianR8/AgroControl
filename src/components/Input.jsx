export default function Input({
  ...
  return (
    <div className={`block w-full mb-4 ${colSpan ? `col-span-${colSpan}` : ''} my-1`}>
      ...
      <input type={typeInput} id={nameRegister} placeholder={placeholder} className={`${className} ${errorInput ? 'border-red-500' : 'border-transparent focus:border-main-green-500 '} border border-gray-400 rounded-lg w-full `} {...register}{...props} />

...
const Document = () => {
    ...
    useEffect(() => {
        getDownloadURL(ref(storage, `database/${folder}/${filename}`)).then((url) => {
            setResume(url);
        });
    }, [folder, filename]);
    ...
    return (
        loading ? <Spinner /> : (
            <CardComponent>
                <div className="bg-gray-400 shadow-md rounded-lg px-8 mx-52 text-center">
                            ...
                            {user.role !== "user2" && (
                                <>
                                    ...
                                    >
                                        ...
                                        <Tooltip id="botonUpload" effect="float" style={{zIndex: 999 }}>
                                            Subir archivo
                                        </Tooltip>
                                    </button>
                                        ...
                                        <Link to='/edit-hv' state={{ title: title, folder: folder, code: String(code), name2: name2 }}>
                                            <button
                                                ...
                                                <MdEditDocument onClick={() =>
                                                    ...
                                                    className='md:h-14 md:w-14 2xl:h-16 2xl:w-16 hover:scale-110 duration-200'></MdEditDocument>
                                                <Tooltip id="botonTooltipEdithv" effect="float">Rellenar formulario - Hoja de vida</Tooltip>
                                            </button>
                                        </Link>
                                    )}
                                </>
                                ...
                                <>
                                    ...
                                    {filename && (
                                        <div className='flex justify-center x-2'>
                                            <ButtonPdf setModal={setModal} resume={resume} name={filename} folder='hv' />
                                            {modal === true && (
                                            ...
                                            <div className='flex justify-center space-x-4'>
                                                {user.role !== "user2" && (
                                                    <label className='text-gray-950 md:text-md lg:text-lg flex items-center justify-center absolute bottom-40 right-96 mt-6'>Hoja de vida:</label>
                                                ...
                                                {user.role !== "user2" && (
                                                    <>
                                                        ...
                                                        >
                                                            ...
                                                            <Tooltip id="botonUploadhv" effect="float">Subir archivo - Hoja de vida</Tooltip>
                                                        </button>
                                                        ...
                                                        <Link to='/edit-hv' state={{ title: title, folder: folder, code: String(code), name2: name2 }}>
                                                            ...
                                                            >
                                                                ...
                                                                <Tooltip id="botonFill" effect="float">Rellenar formulario - Hoja de vida</Tooltip>
                                                            </button>
                                                        </Link>

                                                        {filename.endsWith('docx') &&  (
                                                        <Link to='/edit-hv' state={{ title: title, name: name, folder: folder, code: String(code), name2: name2 }}>
                                                            <button
                                                                data-tooltip-id="botonTooltipEdithv"
                                                            ...
                                                            >
                                                                ...
                                                                <Tooltip id="botonTooltipEdithv" effect="float">Editar hoja de vida</Tooltip>
                                                            </button>
                                                        </Link>
                                                        )}
                                                        ...
                                                        {user.role === 'admin' && (
                                                            ...
                                                            >
                                                                ...
                                                                <Tooltip id="botonTooltipDeletehv" effect="float">Eliminar hoja de vida</Tooltip>
                                                            </button>
                                                        )}
                                    ...
                                    {filename2 && (
                                        <div className='flex justify-center space-x-4'>
                                            <ButtonPdf setModal={setModal2} resume={resume2} name={filename2} folder='rps'/>
                                            {modal2 && (
                                                <Modal setModal={setModal2} resume={resume2} />
                                            )}

                                            {user.role !== "user2" && (
                                                <label className='text-gray-950 md:text-md lg:text-lg flex items-center justify-center absolute bottom-24 right-96 mt-6'>Reporte de servicio:</label>
                                            ...
                                            {user.role !== "user2" && (
                                                <>
                                                    ...
                                                    >
                                                        <AiOutlineUpload className='md:h-6 md:w-6 lg:h-10 lg:w-10 2xl:h-14 2xl:w-14 hover:scale-110 duration-200'></AiOutlineUpload>
                                                        <Tooltip id="botonUpload" effect="float">Subir archivo - Reporte de servicio</Tooltip>

                                                    </button>
                                                   
                                                    <Link to='/edit-rs' state={{ title: title, name:name, folder: folder, code: String(code) }}>
                                                        <button
                                                        ...
                                                        >
                                                            <FaFileWaveform  className='md:h-6 md:w-6 lg:h-10 lg:w-10  2xl:h-14 2xl:w-14 hover:scale-110 duration-200'></FaFileWaveform>
                                                            <Tooltip id="botonFillrs" effect="float">Rellenar formulario - Reporte de servicio</Tooltip>
                                                        </button>
                                                    </Link>

                                                    {filename2.endsWith('docx') &&  (
                                                    <Link to='/edit-rs' state={{ title: title, name:name, folder: folder, code: String(code), name2: name2 }}>
                                                        <button
                                                        ...
                                                        >
                                                            ...
                                                            <Tooltip id="botonTooltipEditrs" effect="float">Editar reporte de servicio</Tooltip>
                                                        </button>
                                                    </Link>
                                                        )}
                                                    ...
                                                    {user.role === 'admin' && (
                                                        ...
                                                        >
                                                            <RiDeleteBin5Fill className='z-0 md:h-6 md:w-6 lg:h-10 lg:w-10  2xl:h-14 2xl:w-14 hover:scale-110 duration-200'></RiDeleteBin5Fill>
                                                            <Tooltip id="botonTooltipDeleters" effect="float">Eliminar reporte de servicio</Tooltip>
                                                        </button>
                                                    )}
                                                </>
                                            )}
                                ...
                                <>
                                    ...
                                    <>
                                        ...
                                        {user.role !== "user2" && (
                                            ...
                                            >
                                                <AiOutlineUpload className='md:h-14 md:w-14 2xl:h-16 2xl:w-16 hover:scale-110 duration-200'></AiOutlineUpload>
                                                <Tooltip id="botonUpload" effect="float">Subir archivo</Tooltip>
                                            </button>
                                        )}
                                        {user.role === 'admin' && (
                                            <button
                                            ...
                                            >
                                                ...
                                                <Tooltip id="botonTooltipDelete" effect="float">Eliminar documento</Tooltip>
                                            </button>
                                        )}
                                    </>
                                </>
